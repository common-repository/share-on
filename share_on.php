<?php
/*
Plugin Name: Share On
Version: 1.1
Plugin URI: -
Author: noob69
Author URI: -
Description: Share On - Share's your articles on the next network: delicious,digg,facebook,friendfeed,google,
				myster-wong,myspace,reddit,slashdot,stumbleupon,technorati,twitter and yahoo. 

    Copyright 2011 noob69(Email: slackwave@gmail.com)
...
class social_bookmarks
{
	...
	function social_bookmarks()
	{
		...
		$this->plugin_dir = get_option('siteurl').'/wp-content/plugins/share-on/'; 
		

		// Default Settings
		$this->default_settings = array('dw_sites' => 'delicious|digg|facebook|technorati|stumbleupon|reddit|slashdot|technorati|twitter',		
							'dw_label' => ' ',
							'dw_target' => 'new',
	...
	{
		print("<link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"".$this->plugin_dir."share_on.css\" />\n");
	}
	...
	function admin_menu()
	{
		...
		add_options_page('Semn De Carte', 'Semn De Carte', 8, __FILE__, array(&$this, 'plugin_options'));
...
//  		$this->debug_section();
	...
	function render_plugin()
	{
		...
		$html .= "</div><div id=\"dwcredit\"><a id=\"dwlogo\" href=\"http://www.motorghid.ro\" title=\"anunturi auto\">anunturi auto</a></div>\n";
